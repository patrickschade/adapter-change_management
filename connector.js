 ...
 */
constructUri(serviceNowTable, query) {
...
sendRequest(callOptions,callback) {
  ...
  request(requestOptions, (error, response, body) => {
    this.processRequestResults(error, response, body, callback);//(processedResults, processedError) => callback(processedResults, processedError));
  });
}
